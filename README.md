<div align="center">
  ...
  <h3 align="center">Netflix_CICD_Project</h3>
...
```sh
docker build --build-arg TMDB_V3_API_KEY=your_api_key_here -t Netflix_C-surya .

docker run --name netflix-clone-website --rm -d -p 80:80 Netflix_C-surya
```
